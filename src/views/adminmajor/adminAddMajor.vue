<template>
  <div>
    ...
    <div class="content">
      <div style="padding-top: 28px">请填写招生专业相关信息</div>
      <div>
        <div class="clear">
        ...
        <el-form label-width="120px" :model="form" ref="form" :rules="rules">
          <el-row :gutter="20">
            <el-col :span="8"
              ><el-form-item label="招生专业标题" prop="enrollmentTitle">
                <el-input
          ...
          <el-row :gutter="20">
            <el-col :span="16"
              ><el-form-item label="招生专业封面" prop="coverPicUrl">
                <el-upload
          ...
          <el-row :gutter="20">
            <el-col :span="8"
              ><el-form-item label="招生专业描述" prop="description">
          ...
          <el-row :gutter="20">
            <el-col :span="16"
              ><el-form-item label="招生专业内容" prop="context">
                <el-input
                  type="textarea"
