<template>
  <div>
    ...
    <div class="content">
      <div style="padding-top: 28px">请填写历年真题相关信息</div>
      <div>
        <div class="clear">
        ...
        <el-form label-width="120px" :model="form" ref="form" :rules="rules">
          <el-row :gutter="20">
            <el-col :span="8"
              ><el-form-item label="历年真题标题" prop="previousTitle">
                <el-input
          ...
          <el-row :gutter="20">
            <el-col :span="16"
              ><el-form-item label="历年真题封面" prop="coverPicUrl">
                <el-upload
          ...
          <el-row :gutter="20">
            <el-col :span="8"
              ><el-form-item label="历年真题描述" prop="description">
          ...
          <el-row :gutter="20">
            <el-col :span="16"
              ><el-form-item label="历年真题内容" prop="contextPicUrl">
                <el-upload
                  class="avatar-uploader"
                  action="http://47.96.139.20:8200/adult-exam/app/picture/fileUpload"
                  list-type="picture-card"
